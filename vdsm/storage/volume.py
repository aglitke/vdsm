...
class Volume(object):
    ...
    def _shareLease(self, dstImgPath):
        self.md._shareLease(dstImgPath)
    ...
    def setLeaf(self):
        return self.md.setLeaf()

    def setInternal(self):
        return self.md.setInternal()
    ...
    def getVolumeParams(self, bs=BLOCK_SIZE):
        return self.md.getVolumeParams(bs)
